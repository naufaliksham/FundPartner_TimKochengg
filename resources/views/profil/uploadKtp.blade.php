    ...
    <div class="bg-gray-100 min-h-screen flex items-center justify-center">
        <div class="max-w-md mx-auto bg-white rounded-lg shadow-md p-8">
            <form method="POST" action="{{ route('upload.process') }}" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
                    <h2 class="text-5xl font-bold mb-5 text-center">Upload Foto KTP Anda</h2>
                    <label for="ktp" class="cursor-pointer">
                        <div class="relative bg-gray-100 px-4 py-8 rounded-md">
                            ...
                            <span class="block mt-2 text-sm text-gray-500 text-center">Pilih ktp anda sekarang <br> Seret dan lepaskan di area ini</span>
                            <input type="file" id="ktp" name="ktp" onchange="previewImage(event, 'fotoPreview')" class="hidden">
                        </div>
                    </label>
                </div>
