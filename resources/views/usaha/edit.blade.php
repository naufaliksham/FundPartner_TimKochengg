        ...
        <!--Project Details Top-->
            <section class="about_one">
                ...
                <div id="form" style="margin-top: 10px">
                    <form action="{{ route('updateUsaha', $item->id) }}" method="post" enctype="multipart/form-data" >
                        {{ csrf_field() }}
                        <h1>Form UMKM</h1>
                        <div class="mb-3">
                            {{-- {{ Auth::user()->id }} --}}
                            ...
                            <input type="text" class="form-control Background" name="nama_usaha" value="{{ $item->nama_usaha}}">
                            @error('nama_usaha')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control Background" name="dana" value="{{ $item->dana}}">
                            @error('dana')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="4" cols="50">{{ $item->deskripsi}}</textarea>
